...
-type amqp_method_name() ::
       ...
       | 'connection.update_secret' | 'connection.update_secret_ok' | 'channel.open' | 'channel.open_ok'
...
-type amqp_method() ::
       ...
       | {10, 70} | {10, 71} | {20, 10} | {20, 11} | {20, 20} | {20, 21}
       | {20, 40} | {20, 41} | {30, 10} | {30, 11} | {40, 10} | {40, 11}
       | {40, 20} | {40, 21} | {40, 30} | {40, 31} | {40, 40} | {40, 51}
       ...
       | {60, 100} | {60, 110} | {60, 111} | {60, 120} | {60, 200} | {60, 201}
       | {60, 202} | {90, 10} | {90, 11} | {90, 20} | {90, 21} | {90, 30}
       | {90, 31} | {85, 10} | {85, 11} ).
